        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="{{ route('frontend.index') }}"><img src="{{ asset('frontend/assets/imgs/theme/logo.svg') }}" alt="logo" /></a>
                </div>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        @else
                                        <li>
                                            <a href="{{ route('register') }}"><i class="fi fi-rs-user-add mr-10"></i>Create an Account</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('login') }}"><i class="fi fi-rs-sign-in mr-10"></i>Sign In</a>
                                        </li>
                                        @endif
                                    </ul>
                                </div>
