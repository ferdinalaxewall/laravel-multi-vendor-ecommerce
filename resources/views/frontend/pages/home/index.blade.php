...
@include('frontend.components.home.features-category')
<!--End category slider-->

@include('frontend.components.home.banner')
<!--End banners-->

@include('frontend.components.home.new-product')
<!--Products Tabs-->

@include('frontend.components.home.features-product')
<!--End Best Sales-->
...
<!--Vendor List -->
@include('frontend.components.home.vendor-list')
<!--End Vendor List -->
